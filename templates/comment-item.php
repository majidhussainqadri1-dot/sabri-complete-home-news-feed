...
>
		...
		<div class="sabri-hnf-comment__byline">
			...
			<div class="sabri-hnf-comment__meta">
				...
				<?php if ( 'pending' === $item['status'] ) : ?>
					<span><?php esc_html_e( 'Pending review', 'sabri-complete-home-news-feed' ); ?></span>
				<?php endif; ?>
	...
	<?php if ( ! empty( $item['can_reply'] ) || ! empty( $item['can_edit'] ) || ! empty( $item['can_delete'] ) ) : ?>
		<div class="sabri-hnf-comment__actions">
			<?php if ( ! empty( $item['can_reply'] ) ) : ?>
				<button type="button" data-comment-reply data-comment-id="<?php echo esc_attr( $item['id'] ); ?>" data-author-name="<?php echo esc_attr( $item['author_name'] ); ?>"><?php esc_html_e( 'Reply', 'sabri-complete-home-news-feed' ); ?></button>
			<?php endif; ?>
			<?php if ( ! empty( $item['can_edit'] ) ) : ?>
				<button type="button" data-comment-edit data-comment-id="<?php echo esc_attr( $item['id'] ); ?>"><?php esc_html_e( 'Edit', 'sabri-complete-home-news-feed' ); ?></button>
			<?php endif; ?>
			<?php if ( ! empty( $item['can_delete'] ) ) : ?>
				<button type="button" data-comment-delete data-comment-id="<?php echo esc_attr( $item['id'] ); ?>"><?php esc_html_e( 'Delete', 'sabri-complete-home-news-feed' ); ?></button>
			<?php endif; ?>
		</div>
	<?php endif; ?>
