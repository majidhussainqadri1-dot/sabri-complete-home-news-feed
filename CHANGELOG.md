...
- Preserved WordPress package identity at `1.0.5`, stable runtime/API at `1.0.3`, and database schema at `1.0.0`; no database migration is introduced.
- Canonical deterministic candidate remains `21-sabri-complete-home-news-feed-1.0.5-CONTROLLED-STAGING-CANDIDATE.zip`; Hostinger staging, live deployment and operational acceptance remain separate external gates.
