...
5. Confirm System Check, duplicate-copy status, File 20 native-slot status, authenticated REST status/schema routes, and File 22 workflow health.
...
8. Run fresh-install, upgrade, rollback, permissions, idempotency recovery, preview expiry, pagination, mobile, accessibility, cache, and visual acceptance before production deployment.
