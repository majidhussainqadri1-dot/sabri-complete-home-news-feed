...
foreach ( array( 'implements Workflow_Adapter, Governed_Workflow_Adapter, Lifecycle_Adapter, Diagnostic_Adapter', 'governance_api_version', 'lifecycle_api_version', 'governance_profile', 'lifecycle_capabilities', 'execute_lifecycle', "SCHEMA_VERSION               = '1.0.1'", 'create_draft', 'public function validate', 'public function preview', 'public function submit', 'public function status', 'canonical_url( int $user_id', "return '1.0.3'", "return 'sabri_feed_create_posts'", 'preview_expiry_enforced', 'idempotency_recovery_ready', 'UniversalComposerWorkflowStore::attach_native_marker', 'record_is_expired', "'draft' === (string) get_post_status", 'user_can_publish_institutional_type' ) as $needle ) {
