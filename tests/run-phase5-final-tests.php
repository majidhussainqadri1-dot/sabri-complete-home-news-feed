...
$assert( '4A' === Phase4Contracts::CHECKPOINT, 'Checkpoint changed before release promotion.' );
$assert( '1.0.0' === SABRI_HNF_VERSION && '1.0.0' === SABRI_HNF_SCHEMA_VERSION, 'Version constants changed early.' );
