...
$assert( str_contains( $companions, 'FILE20_SHA: 7b4019091d1f83ef4cd9dc3f559abb2b3a95955d' ), 'current File 20 exact head is pinned' );
...
$assert( str_contains( $companions, 'FILE04_SHA: 4d6266413b377fda451894b1c7076f2ce93f50fc' ), 'current File 04 exact head is pinned' );
...
$assert( str_contains( $companions, 'FILE24_SHA: 2b303722e68869cc59cfd0a621f770e5b2826ebf' ), 'current File 24 exact head is pinned' );
