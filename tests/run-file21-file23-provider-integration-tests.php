...
$assert( str_contains( $bridge, "interface_exists( 'SPDB_Provider_Adapter' )" ), 'load-order guards the base File 23 interface' );
$assert( str_contains( $bridge, "interface_exists( 'SPDB_Workspace_Provider_Adapter' )" ), 'load-order guards workspace projection interface' );
$assert( str_contains( $bridge, "interface_exists( 'SPDB_Review_Calendar_Provider_Adapter' )" ), 'load-order guards review/calendar interface' );
...
$assert( ! str_contains( $adapter, 'update_post' ), 'adapter does not mutate native posts directly' );
