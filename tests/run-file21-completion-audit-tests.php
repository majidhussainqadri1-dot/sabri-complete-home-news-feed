...
sabri_file21_completion_assert( false !== strpos( $timeline, 'PostMetadata::user_can_view( $post_id, $viewer )' ) && false !== strpos( $timeline, "get_post_field( 'post_author'" ), 'File 03 timeline projection must revalidate viewer authorization and author ownership.' );
