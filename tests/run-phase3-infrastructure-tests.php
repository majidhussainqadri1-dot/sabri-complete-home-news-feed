...
sabri_phase3a_assert( '1.0.1' === $identity['version'] && '1.0.0' === $identity['schema_version'], 'Checkpoint 3A must remain compatible with runtime 1.0.1 while preserving schema 1.0.0.' );
