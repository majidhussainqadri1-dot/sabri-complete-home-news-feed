...
| 40 | Final exact-head release evidence and forty-round closure | DEFECT | Final review found no executable gate proving all 40 rounds/counts and no builder evidence line for this audit. Added `run-file21-forty-round-review-tests.php`, wired it into exact-head workflows, bound build evidence to the 40/40 ledger, then required fresh GitHub exact-head CI before acceptance. |
