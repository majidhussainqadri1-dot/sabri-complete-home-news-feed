# File 21 — Mixed-Role Authority Hotfix 1.0.3.1
...
- WordPress package version: `1.0.3.1`
- File 21 runtime/API compatibility: `1.0.3`
- Schema: `1.0.0`
- Canonical folder: `sabri-complete-home-news-feed`
- Hotfix package: `21-sabri-complete-home-news-feed-1.0.3.1-MIXED-ROLE-AUTHORITY-HOTFIX.zip`

## Deployment boundary

The package must be installed on staging first. WordPress must display Version `1.0.3.1`. After activation or replacement, one authenticated Administrator request must be made so the existing bounded capability reconciliation can run. Cache purge, `/create/` verification, mixed-role verification, rollback proof, and explicit Founder approval remain mandatory before live promotion.
