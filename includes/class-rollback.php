...
final class Rollback {
	...
	public static function preview() {
		...
		return array(
			...
			'will_restore'        => array( 'plugin settings', 'schema version option', 'plugin capability assignments', 'rewrite refresh flag' ),
	...
	public static function execute() {
		...
		$report['steps'][]     = 'Restored plugin capability assignments from snapshot.';
