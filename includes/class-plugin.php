...
final class Plugin {
	...
	public function register(){
		...
		$modules=array(
			Settings::class,HarmonizedSettings::class,CanonicalIdentityAdapter::class,CompanionIntegrationRegistry::class,SearchProviderRegistry::class,File24SecurityManifestBridge::class,File01ReconciliationAdapter::class,
