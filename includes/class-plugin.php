...
final class Plugin {
	...
	public function register(){
		...
		$modules=array(
			...
			FollowersVisibility::class,FollowersQueryGuard::class,MediaHandler::class,ViralRankingSignals::class,NetworkRelationshipBridge::class,FeedUserAgency::class,SavedCollectionService::class,FeedQuery::class,UniversalComposerBridge::class,File23PublishingDashboardBridge::class,PublicComposerSurface::class,HomeIntegration::class,HomeCompositionRegistry::class,CompanionHomeRowAdapters::class,LegacyInteractionMigrationAdapter::class,LegacyPublicationMigration::class,LegacyPublicationRollback::class,ViewRuntime::class,PollRuntime::class,
