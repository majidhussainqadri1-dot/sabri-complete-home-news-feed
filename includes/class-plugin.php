...
final class Plugin {
	...
	public function register(){
		...
		$modules=array(
			Settings::class,HarmonizedSettings::class,CanonicalIdentityAdapter::class,CompanionIntegrationRegistry::class,SearchProviderRegistry::class,File01ReconciliationAdapter::class,File04MigrationContracts::class,
