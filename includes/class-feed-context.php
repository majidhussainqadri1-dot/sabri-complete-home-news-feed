...
final class FeedContext {
	...
	/**
	 * Phase 2 feed types that can be created from the public composer.
	 *
	...
	/**
	 * Visibility slugs allowed in Phase 2 composer controls.
	 *
	 * @param bool $include_private Include Private Draft.
	 * @return array<int,string>
	 */
	 ...
	 * @param array<string,mixed>|null $settings Settings.
	 * @param bool                     $include_private Include private drafts.
	 * @return string
	 */
	...
	/**
	 * Visibility modes configured for Phase 2 composer use.
	 *
	 * @param array<string,mixed>|null $settings Settings.
	 * @param bool                     $include_private Include private drafts.
	 * @return array<int,string>
	 ...
	 *
	 * @param mixed                    $value Raw per-page.
	 * @param array<string,mixed>|null $settings Settings.
	 * @return int
	 */
